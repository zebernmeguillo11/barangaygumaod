...
$pdf->Cell(210,15, 'CERTIFICATE OF INDIGENCY', 0,0,'C');
$pdf->Ln();
...
$pdf->SetXY(30,75);
$lettercontent = "      This is to certify that ".$fullname.", of legal age presently residing at ".$fulladdress.".";
$pdf->Write(5, $lettercontent);
$pdf->Ln();

$pdf->SetXY(30,90);
$lettercontent2 = "    These further certifies that base on barangay record their combined income is belong to the indigent family and below average threshold income amounting to 3,000 a month total annual income is P/36,000.00.";
$pdf->Write(5, $lettercontent2);
$pdf->Ln();

$pdf->SetXY(30,110);
$lettercontent3 = "     This certification is being issued upon the request of the above named mention for financial assistance.";
