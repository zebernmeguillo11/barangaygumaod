...
$pdf->Cell(210,15, 'CERTIFICATION', 0,0,'C');
$pdf->Ln();
...
$pdf->SetXY(30,75);
$lettercontent = "      This is to certify that, ".$fullname.", of legal age resident of ".$fulladdress.".";
$pdf->Write(5, $lettercontent);
$pdf->Ln();

$pdf->SetXY(30,90);
$lettercontent2 = "       Furthermore, certifies that she had a ".$_GET['variety']." planted in their area located ".$_GET['location']." of this barangay and she going to cut it down for the use for".$_GET['purpose'].".";
$pdf->Write(5, $lettercontent2);
$pdf->Ln();

$pdf->SetXY(30,110);
$lettercontent3 = "     This certification is being issued upon the request of the above name for PROVING her OWNERSHIP.";
