...
if(!isset($_SESSION['searchpage'])){
    $_SESSION['searchpage'] = 1;
}
$_SESSION['limit'] = 6;

if(!isset($_SESSION['searchpage1'])){
    $_SESSION['searchpage1'] = 1;
}
$_SESSION['limit1'] = 4;
...
<body>
    ...
    <div class="main">
        ...
        <div class="container mainsection ">
            ...
            <label for="search" class="ml-4 w-50 my-2 text-center" style="float: right;" >Search:<input type="text" name="search" id="search"></label>
        <div class="section1">
            <table class="w-100 text-center table table-striped table-hover table-light">
                ...
                $offset = ($_SESSION['searchpage']-1)*$_SESSION['limit']; 
	...
	<?php
		 $buttonnum = 1;
			while($buttonnum<$totalpage){
				if($_SESSION['searchpage']==$buttonnum){
?>
<button class="pagebutton btn btn-secondary" value="<?php echo htmlentities($buttonnum);?>" onclick = "setpage1(this.value)" ><?php echo $buttonnum; ?></button>
<?php
				}else{
					?>
<button class="pagebutton btn btn-primary" value="<?php echo htmlentities($buttonnum);?>" onclick = "setpage1(this.value)" ><?php echo $buttonnum; ?></button>
					<?php
				}
...
?>
<button class="pagebutton btn btn-secondary" value="<?php echo htmlentities($buttonnum);?>" onclick = "setpage1(this.value)" ><?php echo $buttonnum1; ?></button>
<?php
				}else{
					?>
<button class="pagebutton btn btn-primary" value="<?php echo htmlentities($buttonnum);?>" onclick = "setpage1(this.value)" ><?php echo $buttonnum1; ?></button>
					<?php
				}
    ...
    <div class="custommodal p-2" id="addtofam">
        ...
        <div class="w-25 p-2 " style="float:right"> 
            <button class="closebtn w-50 py-1" onclick="closeaddfammodal()" ><img src="img/close.png" class="img-thumbnail img-fluid"></button>
        </div>
    ...
    <div class="custommodal p-2" id="editfam">
        ...
        <div class="w-25 p-2 " style="float:right"> 
            <button class="closebtn w-50 py-1" onclick="closeeditfam()" ><img src="img/close.png" class="img-thumbnail img-fluid"></button>
        </div>
        <div class="inputdiv container w-100">
        ...
        <div class="inputdiv container w-100">
    			...
    			<input type="text" class="form-control w-100" id="edithouse" required>
